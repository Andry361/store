...
var users_service_1 = __webpack_require__("./src/app/pages/users/users.service.ts");
var UsersTable = (function () {
    function UsersTable(service) {
        var _this = this;
    ...
    UsersTable.prototype.onCreateConfirm = function (event) {
        alert(event);
    };
    UsersTable.prototype.onDeleteConfirm = function (event) {
    ...
    UsersTable = __decorate([
        core_1.Component({
            ...
            styles: [__webpack_require__("./src/app/pages/users/users.scss")],
            template: __webpack_require__("./src/app/pages/users/users.html")
        }), 
        __metadata('design:paramtypes', [(typeof (_a = typeof users_service_1.UsersTableService !== 'undefined' && users_service_1.UsersTableService) === 'function' && _a) || Object])
    ], UsersTable);
    return UsersTable;
    var _a;
}());
...
/***/ "./src/app/pages/users/users.html":
/***/ function(module, exports) {

module.exports = "<div class=\"widgets\">\r\n\r\n  <div class=\"row\">\r\n    <ba-card title=\"Basic Example\" baCardClass=\"with-scroll\">\r\n      <ng2-smart-table [settings]=\"settings\" [source]=\"source\" (deleteConfirm)=\"onDeleteConfirm($event)\" (createConfirm)=\"onCreateConfirm($event)\"></ng2-smart-table>\r\n    </ba-card>\r\n  </div>\r\n\r\n</div>\r\n"
...
var users_routing_1 = __webpack_require__("./src/app/pages/users/users.routing.ts");
var users_component_1 = __webpack_require__("./src/app/pages/users/users.component.ts");
var users_service_1 = __webpack_require__("./src/app/pages/users/users.service.ts");
var UsersModule = (function () {
    ...
    UsersModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [
                users_component_1.UsersTable,
            ],
            providers: [
                users_service_1.UsersTableService
            ]
        }), 
        __metadata('design:paramtypes', [])
    ], UsersModule);
...
/***/ "./src/app/pages/users/users.routing.ts":
/***/ function(module, exports, __webpack_require__) {
...
var routes = [
    {
        path: '',
        component: users_component_1.UsersTable,
        children: []
    }
];
...
/***/ "./src/app/pages/users/users.scss":
/***/ function(module, exports) {
...
var core_1 = __webpack_require__("./node_modules/@angular/core/index.js");
var http_1 = __webpack_require__("./node_modules/@angular/http/index.js");
var UsersTableService = (function () {
    function UsersTableService(http) {
        this.http = http;
        this.usersUrl = '/api/User';
    }
    UsersTableService.prototype.getData = function () {
        return this.http.get(this.usersUrl)
            .toPromise()
            .then(function (response) { return response.json(); });
        //  .catch(this.handleError);
    };
    UsersTableService = __decorate([
        core_1.Injectable(), 
