...
var groups_service_1 = __webpack_require__("./src/app/pages/groups/groups.service.ts");
var GroupsTable = (function () {
    function GroupsTable(service) {
        var _this = this;
    ...
    GroupsTable.prototype.onDeleteConfirm = function (event) {
    ...
    GroupsTable = __decorate([
        core_1.Component({
            ...
            styles: [__webpack_require__("./src/app/pages/groups/groups.scss")],
            template: __webpack_require__("./src/app/pages/groups/groups.html")
        }), 
        __metadata('design:paramtypes', [(typeof (_a = typeof groups_service_1.GroupsTableService !== 'undefined' && groups_service_1.GroupsTableService) === 'function' && _a) || Object])
    ], GroupsTable);
    return GroupsTable;
    var _a;
}());
...
/***/ "./src/app/pages/groups/groups.html":
/***/ function(module, exports) {
...
var ng2_smart_table_1 = __webpack_require__("./node_modules/ng2-smart-table/build/ng2-smart-table.js");
var groups_routing_1 = __webpack_require__("./src/app/pages/groups/groups.routing.ts");
var groups_component_1 = __webpack_require__("./src/app/pages/groups/groups.component.ts");
var groups_service_1 = __webpack_require__("./src/app/pages/groups/groups.service.ts");
var GroupsModule = (function () {
    ...
    GroupsModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [
                groups_component_1.GroupsTable,
            ],
            providers: [
                groups_service_1.GroupsTableService
            ]
        }), 
        __metadata('design:paramtypes', [])
    ], GroupsModule);
...
/***/ "./src/app/pages/groups/groups.routing.ts":
/***/ function(module, exports, __webpack_require__) {
...
var routes = [
    {
        path: '',
        component: groups_component_1.GroupsTable,
        children: []
    }
];
...
/***/ "./src/app/pages/groups/groups.scss":
/***/ function(module, exports) {
...
"use strict";
var core_1 = __webpack_require__("./node_modules/@angular/core/index.js");
var GroupsTableService = (function () {
    function GroupsTableService() {
        this.smartTableData = [
            {
                id: 1,
                firstName: 'Mark',
    ...
    GroupsTableService.prototype.getData = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            setTimeout(function () {
    ...
    GroupsTableService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [])
    ], GroupsTableService);
    return GroupsTableService;
}());
exports.GroupsTableService = GroupsTableService;
